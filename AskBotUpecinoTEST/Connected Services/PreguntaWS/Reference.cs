...
namespace AskBotUpecinoTEST.PreguntaWS {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="PreguntaWS.IAskBotUpecinoService")]
    public interface IAskBotUpecinoService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAskBotUpecinoService/ObtenerPreguntaMasPopularPorCurso", ReplyAction="http://tempuri.org/IAskBotUpecinoService/ObtenerPreguntaMasPopularPorCursoRespons" +
            "e")]
        [System.ServiceModel.FaultContractAttribute(typeof(AskBotUpecinoTEST.PreguntaWS.PreguntaException), Action="http://tempuri.org/IAskBotUpecinoService/ObtenerPreguntaMasPopularPorCursoPregunt" +
            "aExceptionFault", Name="PreguntaException", Namespace="http://schemas.datacontract.org/2004/07/AskBotUpecino.Errores")]
        AskBotUpecinoTEST.PreguntaWS.Pregunta ObtenerPreguntaMasPopularPorCurso(string idCurso);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAskBotUpecinoService/ObtenerPreguntaMasPopularPorCurso", ReplyAction="http://tempuri.org/IAskBotUpecinoService/ObtenerPreguntaMasPopularPorCursoRespons" +
            "e")]
        System.Threading.Tasks.Task<AskBotUpecinoTEST.PreguntaWS.Pregunta> ObtenerPreguntaMasPopularPorCursoAsync(string idCurso);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IAskBotUpecinoServiceChannel : AskBotUpecinoTEST.PreguntaWS.IAskBotUpecinoService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AskBotUpecinoServiceClient : System.ServiceModel.ClientBase<AskBotUpecinoTEST.PreguntaWS.IAskBotUpecinoService>, AskBotUpecinoTEST.PreguntaWS.IAskBotUpecinoService {
        ...
        public AskBotUpecinoTEST.PreguntaWS.Pregunta ObtenerPreguntaMasPopularPorCurso(string idCurso) {
            return base.Channel.ObtenerPreguntaMasPopularPorCurso(idCurso);
        }
        
        public System.Threading.Tasks.Task<AskBotUpecinoTEST.PreguntaWS.Pregunta> ObtenerPreguntaMasPopularPorCursoAsync(string idCurso) {
